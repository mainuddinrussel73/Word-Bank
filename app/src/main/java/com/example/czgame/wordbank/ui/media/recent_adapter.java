...
public class recent_adapter extends RecyclerView.Adapter<recent_adapter.ViewHolder> {
    ...
    public recent_adapter(Activity context,EventListener listener, List<Audio> songs) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        Audio myListData = recentlyList.get(position);
        System.out.println(myListData.toString());
