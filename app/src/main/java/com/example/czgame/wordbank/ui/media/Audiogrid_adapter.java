...
public class Audiogrid_adapter  extends RecyclerView.Adapter<Audiogrid_adapter.ViewHolder> {

    private final Activity context;
    List<Audio> contactList;
    Audiogrid_adapter.EventListener listener;
    List<Audio> audioList ;

    public Audiogrid_adapter(Activity context, Audiogrid_adapter.EventListener listener, List<Audio>  queue) {
    ...
    @NonNull
    @Override
    public Audiogrid_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem= layoutInflater.inflate(R.layout.music_item_grid, parent, false);
        Audiogrid_adapter.ViewHolder viewHolder = new Audiogrid_adapter.ViewHolder(listItem);
        return viewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull Audiogrid_adapter.ViewHolder holder, int position) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            listitem = itemView.findViewById(R.id.grid_item);
