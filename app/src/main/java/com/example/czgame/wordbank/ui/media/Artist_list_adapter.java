...
public class Artist_list_adapter extends RecyclerView.Adapter<Artist_list_adapter.ViewHolder> {
    ...
    public Artist_list_adapter(Activity context,ArrayList<Audio> songs) {
