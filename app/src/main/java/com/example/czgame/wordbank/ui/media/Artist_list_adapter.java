...
import static com.example.czgame.wordbank.ui.media.detail_artist.songs;

public class Artist_list_adapter extends BaseAdapter {
    ...
    public Artist_list_adapter(Activity context) {
